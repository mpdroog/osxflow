...
// flag is for.
func DetectScale(xu *xgbutil.XUtil, override float64) float64 {
	return scale.Detect(xu, override)
}

func scaleFromEnv() (float64, bool) { return scale.FromEnv() }

func scaleFromXfconfFile(path string) (float64, bool) { return scale.FromXfconfFile(path) }
