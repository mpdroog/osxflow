...
| [`cmd/macmenu`](cmd/macmenu) | The system menu at the left of the panel, as under macOS's Apple logo: About This Linux, settings, task manager, sleep, restart, shut down, lock, log out. Runs only while open. Replaces Whisker Menu; apps stay with the launcher. |
